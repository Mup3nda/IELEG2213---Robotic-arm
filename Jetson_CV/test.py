...
X_CORRECTION_SCALING = 1.40  # Scaling factor for correction based on distance
Y_CORRECTION_SCALING = 1.60  # Scaling factor for correction based on distance
        ...
        while True:
            ...
            for detection in detections:
                if detection.ClassID == MOUSE_CLASS_ID:
                    ...
                    corrected_x = round(BASE_CORRECTION_FACTOR + (avg_x * X_CORRECTION_SCALING ))
                    corrected_y = round(BASE_CORRECTION_FACTOR + (avg_y * Y_CORRECTION_SCALING))
